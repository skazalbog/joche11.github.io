...
function JUEGOlvl3() {
    ...
    function perdistelvl3() {
        ...
        // Verificar si los meteoritos han cruzado la línea en el NIVEL 3
        if (
            document.getElementById("Meteoritolvl3").offsetLeft > umbral ||
            document.getElementById("Meteorito2lvl3").offsetLeft > umbral ||
            document.getElementById("Meteorito3lvl3").offsetLeft > umbral ||
            document.getElementById("Meteorito4lvl3").offsetLeft > umbral
        ) {
            ...
            // Aplicar transición solo si los meteoritos no han cruzado la línea en el NIVEL 2
            document.getElementById("Meteoritolvl3").style.transition = "2.4s";
            document.getElementById("Meteorito2lvl3").style.transition = "2.4s";
            document.getElementById("Meteorito3lvl3").style.transition = "2.4s";
            document.getElementById("Meteorito4lvl3").style.transition = "2.4s";
        }
    }
