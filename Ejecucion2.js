...
function JUEGOlvl2(){
    ...
    function Tiempo_Disminurlvl2(){ //FUNCION QUE REDUCE EL TIEMPO Y RESETEAL EL RESULTADO UNA VEZ LLEGUE A 0
        ...
        function perdistelvl2() {
            ...
            // Verificar si los meteoritos han cruzado la línea en el NIVEL 2
            if (
                document.getElementById("Meteioritolvl2").offsetLeft > umbral ||
                document.getElementById("Meteiorito2lvl2").offsetLeft > umbral ||
                document.getElementById("Meteiorito3lvl2").offsetLeft > umbral
            ) {
